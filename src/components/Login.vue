<template>
   <div class="flex justify-center mb-8">
    <form @submit.prevent="loginUser" class="m-4 mt-20 p-4 w-full max-w-[600px] bg-white rounded-lg shadow-lg">
        ...
        <input v-model="username" type="text" id="username" name="username" placeholder="Ange ditt användarnamn" class="w-full p-2 border-2 border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-green-800">
        </p>
        <p class="p-4">
        ...
        <input v-model="password" type="password" id="password" name="password" placeholder="Ange ditt lösenord" class="w-full p-2 border-2 border-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-green-800">
        </p>
        <div class="p-4">
